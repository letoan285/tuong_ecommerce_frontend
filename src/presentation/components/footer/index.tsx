                                    ...
                                    <div className="row">
                                        <div className="wrap-footer-item twin-item">
                                            ...
                                            <div className="item-content">
                                                <div className="wrap-vertical-nav">
                                                    <ul>
                                                        <li className="menu-item"><a href="#" className="link-term">My Account</a></li>
                                                        <li className="menu-item"><a href="#" className="link-term">Brands</a></li>
                                                        <li className="menu-item"><a href="#" className="link-term">Gift Certificates</a></li>
                                                        <li className="menu-item"><a href="#" className="link-term">Affiliates</a></li>
                                                        <li className="menu-item"><a href="#" className="link-term">Wish list</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="wrap-footer-item twin-item">
                                            ...
                                            <div className="item-content">
                                                <div className="wrap-vertical-nav">
                                                    <ul>
                                                        <li className="menu-item"><a href="#" className="link-term">Contact Us</a></li>
                                                        <li className="menu-item"><a href="#" className="link-term">Returns</a></li>
                                                        <li className="menu-item"><a href="#" className="link-term">Site Map</a></li>
                                                        <li className="menu-item"><a href="#" className="link-term">Specials</a></li>
                                                        <li className="menu-item"><a href="#" className="link-term">Order History</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="wrap-footer-item">
                                        ...
                                        <div className="item-content">
                                            <div className="wrap-list-item wrap-gallery">
                                                <img src="assets/images/payment.png" style={{maxWidth: '260px'}} />
									</div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="wrap-footer-item">
                                            ...
                                            <div className="item-content">
                                                <div className="wrap-list-item apps-list">
                                                    <ul>
                                                        <li><a href="#" className="link-to-item" title="our application on apple store"><figure><img src="assets/images/brands/apple-store.png" alt="apple store" width="128" height="36" /></figure></a></li>
                                                            <li><a href="#" className="link-to-item" title="our application on google play store"><figure><img src="assets/images/brands/google-play-store.png" alt="google play store" width="128" height="36" /></figure></a></li>
										</ul>
									</div>
								</div>
                                                </div>
                                    ...
                                    <div className="container">
                                        ...
                                        <div className="coppy-right-item item-right">
                                            <div className="wrap-nav horizontal-nav">
                                                <ul>
                                                    <li className="menu-item"><a href="about-us.html" className="link-term">About us</a></li>
                                                    <li className="menu-item"><a href="privacy-policy.html" className="link-term">Privacy Policy</a></li>
                                                    <li className="menu-item"><a href="terms-conditions.html" className="link-term">Terms & Conditions</a></li>
                                                    <li className="menu-item"><a href="return-policy.html" className="link-term">Return Policy</a></li>
                                                </ul>
                                            </div>
                                        </div>
